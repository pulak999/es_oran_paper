...
forecast = m.predict(temp_train)


plt.plot(temp_train['ds'], temp_train['y'], 'blue', forecast1['ds'], forecast1['yhat'], 'green')
#plt.plot(temp_test['ds'], temp_test['y'], 'orange', forecast2['ds'], forecast2['yhat'], 'green')
